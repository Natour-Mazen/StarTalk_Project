...
export default function UpdateCitationModal({visible, setVisible , citation}) {
    ...
    const showSuccessToast = () => {
        toast.current.show({severity:'success', summary: 'Success', detail:'Your masterpiece has just been updated 🤌', life: 2700});
    }
    ...
    const onSubmit = async (data) => {
        ...
        if (titre !== '' && description !== '') {
            try {
                ...
                const response = await axios.patch(`/startalk-api/citations/${citation._id}`, payload, {
